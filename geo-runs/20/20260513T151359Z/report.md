...
_生成时间: 2026-05-13T15:14:02.506Z_
_触发 Issue: #20_
...
**https://forum.openeuler.org/t/topic/4537**  ❌ FAIL  (🔴 1 / 🟡 0 / ⚪ 1)

| 维度 | 结果 |
| --- | --- |
| 静态化 | ✅ http-fallback |
| Schema | ✅ QAPage |
| TDK | ✅ title=44/desc=128 |
| Sitemap | ❌ 未收录 |

- ⚪ **[minor/tdk]** Keywords 缺失
...
{
  "version": 1,
  "run_at": "2026-05-13T15:14:02.506Z",
  "trigger_issue": "20",
  "issues": [
    {
      "community": "openEuler",
      ...
      "questions": [
        {
          "id": "q_016",
          "question": "openEuler 22.03 LTS SP2 上如何修复 CVE-2024-1086 内核提权漏洞？",
          "official_urls": [
            {
              "url": "https://forum.openeuler.org/t/topic/4537",
              "final_url": "https://forum.openeuler.org/t/topic/4537",
              "problems": [
                {
                  "severity": "critical",
